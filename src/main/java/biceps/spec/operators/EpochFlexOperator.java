...
public class EpochFlexOperator extends Operator {
    ...
    final public Input<IntVectorParam<PositiveInt>> groupSizeParamInput = new Input<>("groupSizes", "the group sizes parameter. If specified, use group sizes as boundaries"
    ...
    private IntVectorParam<PositiveInt> groupSizes;
    ...
    public double proposal() {
		...
		if (groupSizes != null) {
			int k = Randomizer.nextInt(groupSizes.size());
			...
			intervalHi = treeIntervals.getIntervalTime(j + groupSizes.get(k));
		} else {
